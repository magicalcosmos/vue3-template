import { IntegrationTestCaseTransformer } from 'smart-rocket-unit';

class IntegrationTransformer extends IntegrationTestCaseTransformer {
  constructor(
...
export default IntegrationTransformer;
