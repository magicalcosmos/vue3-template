...
(function(global, factory) {
  ...
  var Hash =
    /*#__PURE__*/
    (function() {
      function Hash(salt, minLength, alphabet, seps) {
        if (salt === void 0) {
          salt = '';
        }
        ...
        if (typeof minLength !== 'number') {
          throw new TypeError("Hash: Provided 'minLength' has to be a number (is " + typeof minLength + ')');
        }
  
        if (typeof salt !== 'string') {
          throw new TypeError("Hash: Provided 'salt' has to be a string (is " + typeof salt + ')');
        }
  
        if (typeof alphabet !== 'string') {
          throw new TypeError('Hash: Provided alphabet has to be a string (is ' + typeof alphabet + ')');
        }
  
        var uniqueAlphabet = keepUniqueChars(alphabet);
  
        if (uniqueAlphabet.length < minAlphabetLength) {
          throw new Error('Hash: alphabet must contain at least ' + minAlphabetLength + ' unique characters, provided: ' + uniqueAlphabet);
        }
       ...
       * Hash.encode([0x100000000000f, 0x100000000000f, 0x1000f])
       *
       * This means that if your environment supports BigInts,
       * you will get different (shorter) results if you provide
       * a BigInt representation of your hex and use `encode` directly, e.g.:
       * Hash.encode(BigInt(`0x${hex}`))
       *
       * To decode such a representation back to a hex string, use the following snippet:
       * Hash.decode(id)[0].toString(16)
       */
      ;
      ...
      _proto.encodeHex = function encodeHex(hex) {
        switch (typeof hex) {
          ...
          default:
            throw new Error('Hash: The provided value is neither a string, nor a BigInt (got: ' + typeof hex + ')');
        }
